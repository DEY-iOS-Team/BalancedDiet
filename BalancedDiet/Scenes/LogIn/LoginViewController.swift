...
final class LoginViewController: UIViewController {
    ...
    private func validationErrorType(error: Login.LoginValidation.ValidationError) {
        switch error {
        case .email:
    ...
    private func errorType(error: Login.LoginValidation.ErrorType) {
        switch error {
    ...
    @objc private func loginButtonPressed() {
        ...
        interactor.login(request: Login.LoginValidation.Request(email: email, password: password))
    }
